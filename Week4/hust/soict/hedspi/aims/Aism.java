...
public class Aism {
	...
	static void showCreationMenu(ArrayList <Media> items, Order order, Scanner sca) {
		...
		do {
			...
			choice = sca.nextInt();
			switch(choice) {
			case 1: //create DVD product
			case 2: //create CD product
			case 3: //create Book product
				order.newItem(items, choice);
                break;
			case 0:
    ...
    static Media createItemFromConsole(AbstractItemFactory factory) {
