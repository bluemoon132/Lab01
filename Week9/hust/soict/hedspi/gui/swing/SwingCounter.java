...
public class SwingCounter extends JFrame { // JFrame instead of Frame
	...
	private int count = 0;
	// Constructor to setup the GUI components and event handlersPage 10 of 17
	...
	public SwingCounter() {
		...
		// All operations done on the content-pane
		 ...
		 SwingUtilities.invokeLater(new Runnable() { @Override  public void run() { new SwingCounter(); }});
		 }
}
